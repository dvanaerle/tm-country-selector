  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed bottom-0 z-50 grid max-h-[calc(100%-1rem)] w-full max-w-(--breakpoint-sm) gap-4 overflow-x-auto rounded-t-lg bg-white p-6 shadow-lg duration-200 sm:top-1/2 sm:bottom-auto sm:left-1/2 sm:max-h-[calc(100%-3rem)] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg",
          className,
        )}
        {...props}
      >
